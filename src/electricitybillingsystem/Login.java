...
import javax.swing.*;
import java.awt.*; // choice comes from awt
...
public class Login extends JFrame implements ActionListener {
    JTextField userText,passwordText;  // declared globally becuase we have to connect it to database
    Choice loginChoice;
    ...
    Login(){
       ...
       cancelButton.addActionListener(this);
        ...
        ImageIcon profileOne =  new ImageIcon(ClassLoader.getSystemResource("icon/namaste.jfif"));
